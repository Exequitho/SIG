...
<!-- Make sure you put this AFTER Leaflet's CSS -->
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="http://localhost:8000/regencies">Kabupaten/Kota</a></li>
        ...
        <div style="text-align: center">
            <h1>Data Kabupaten/Kota di Indonesia</h1>
        </div>
        <div id="map"></div>
        <script>
            ...
            let regencies = @json($list_kabkota);
            console.log(regencies)

            regencies.forEach(function(regencies){
                L.marker([regencies.latitude, regencies.longitude]).addTo(map).bindPopup(regencies.name)
            })
        </script>
    </body>
</html>